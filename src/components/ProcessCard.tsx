  ...
  return (
    <div className="p-4 bg-gray-700/50 rounded-lg border border-gray-600 space-y-3 transition-all hover:border-sky-600">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
            ...
            <DetailItem label="Valor a Pagar" value={processo.valorAPagar.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })} />
            <DetailItem label="Valor Doc Fiscal" value={processo.valorDocFiscal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })} />
        </div>
        <button
