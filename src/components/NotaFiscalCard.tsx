        ...
        case SyncStatus.SYNCED:
            return (
                <div className="flex items-center text-xs font-medium text-green-400">
                    <CheckIcon className="w-4 h-4 mr-1" /> Synced
                </div>
            );
        case SyncStatus.ERROR:
            return (
                <div className="flex items-center text-xs font-medium text-red-400">
                    <ExclamationIcon className="w-4 h-4 mr-1" /> Error
                </div>
            );
        default:
            return null;
        ...
        >
            ...
            <div className="mt-4 pt-4 border-t border-gray-700 flex flex-col sm:flex-row items-center gap-2">
                <div className="w-full sm:flex-grow flex items-center gap-2">
                    <label htmlFor={`process-no-${nota.id}`} className="text-sm font-medium text-gray-300 hidden sm:inline">
                        Proc.:
                    </label>
                    <input
